...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		endpointdata.Table:         endpointdata.ValidColumn,
		providerendpoint.Table:     providerendpoint.ValidColumn,
		providerregisterdata.Table: providerregisterdata.ValidColumn,
	}
