...
// The EndpointDataFunc type is an adapter to allow the use of ordinary
// function as EndpointData mutator.
type EndpointDataFunc func(context.Context, *ent.EndpointDataMutation) (ent.Value, error)
...
// function as ProviderEndpoint mutator.
type ProviderEndpointFunc func(context.Context, *ent.ProviderEndpointMutation) (ent.Value, error)
...
// function as ProviderRegisterData mutator.
type ProviderRegisterDataFunc func(context.Context, *ent.ProviderRegisterDataMutation) (ent.Value, error)
